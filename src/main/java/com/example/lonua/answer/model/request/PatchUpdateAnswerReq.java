...
@NoArgsConstructor
@AllArgsConstructor
public class PatchUpdateAnswerReq {

    @NotNull(message = "답변 IDX는 필수 입력항목입니다.")
    @Min(value = 1, message = "답변 IDX는 최소 1 이상이어야 합니다.")
    @ApiModelProperty(value = "답변 IDX", example = "1", required = true)
